...
import { Navbar, NavbarBrand, Jumbotron, Nav, NavbarToggler,Form,Collapse, NavItem, Modal, ModalBody,ModalHeader,Button, FormGroup, Label, Input } from 'reactstrap'
                            ...
                            <Nav className="ml-auto" navbar>
                                <NavItem>
                                    <Button outline onClick={this.toggleModal}>
                                        <span className="fa fa-sign-in fa-ld"> Login</span>
                                    </Button>
                                </NavItem>
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <FormGroup>
                                ...
                                <Input type="password" id="username" name="username" innerRef={(input)=>this.password = input}/>
                            </FormGroup>
                            <FormGroup check>
                                <Label check>
